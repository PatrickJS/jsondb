...
function renderGraphqlRoutes(project) {
  return `${generatedHeader()}
import type { Hono } from 'hono';
import { executeGraphql } from 'json-fixture-db';
import type { JsonDbRepository } from './repository.js';
...
function renderPackageJson(options) {
  ...
  if (options.api.includes('graphql')) {
    dependencies['json-fixture-db'] = '^0.1.0';
  }
...
Generated from json-fixture-db schema resources:
...
function generatedHeader(comment = '//') {
  return `${comment} This file is generated by json-fixture-db. Edit it freely after generation.\n`;
}
